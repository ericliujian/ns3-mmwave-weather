...
void MmWaveProp(double particleradius, double stepTime){
...
Simulator::Schedule(Seconds(stepTime), &MmWaveProp, particleradius, stepTime);
...
void computeRxPower(NetDeviceContainer devs, double stepTime) {
  ...
  outdata.open("RxPowerPS.csv", std::ofstream::app); // opens the file
...
// }
  ...
  MmWaveProp(particleradius, stepTime);
