...
*
*/
// Add three weather impacts into consideration
...
MmWaveVehicularPropagationLossModel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::MmWaveVehicularPropagationLossModel")
    ...
    .AddAttribute ("ParticleRadius",
                   ...
                   DoubleValue (0.0),
                   MakeDoubleAccessor (&MmWaveVehicularPropagationLossModel::SetParticleRadius,
                                       &MmWaveVehicularPropagationLossModel::GetParticleRadius),
                   MakeDoubleChecker<double> ())
    .AddAttribute ("VVisibility",
                   "visibility valuue :))",
                   DoubleValue (0.0),
                   MakeDoubleAccessor (&MmWaveVehicularPropagationLossModel::SetVisibility,
                                       &MmWaveVehicularPropagationLossModel::GetVisibility),
                   MakeDoubleChecker<double> ())
    .AddAttribute ("HHumidity",
                   "humidity valuue :))",
                   DoubleValue (0.0),
                   MakeDoubleAccessor (&MmWaveVehicularPropagationLossModel::SetHumidity,
                                       &MmWaveVehicularPropagationLossModel::GetHumidity),
                   MakeDoubleChecker<double> ())
...
void
MmWaveVehicularPropagationLossModel::SetParticleRadius (double particleradius)
{
  ae = particleradius;
}

double
MmWaveVehicularPropagationLossModel::GetParticleRadius (void) const
{
  return ae;
}

void
MmWaveVehicularPropagationLossModel::SetVisibility (double visibility)
{
  v = visibility;
}

double
MmWaveVehicularPropagationLossModel::GetVisibility (void) const
{
  return v;
}

void
MmWaveVehicularPropagationLossModel::SetHumidity (double humidity)
{
  H = humidity;
}

double
MmWaveVehicularPropagationLossModel::GetHumidity (void) const
{
  return H;
}
...
// add compute_Ad into L and v conditions
  if (m_scenario == "V2V-Highway")
  {
