...
EXAMPLE_DIRECTORIES = ['ipv6', 'error-model', 'wireless', 'stats', 'udp', 'channel-models', 'matrix-topology', 'socket', 'realtime', 'energy', 'tutorial', 'tcp', 'traffic-control', 'udp-client-server', 'naming', 'routing']
