...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-Wall', '-std=c++11', '-Wno-parentheses', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-Wall', '-std=c++11', '-Wno-parentheses', '-Wno-error=deprecated-declarations']
...
EXAMPLE_DIRECTORIES = ['routing', 'energy', 'stats', 'error-model', 'naming', 'channel-models', 'socket', 'tcp', 'matrix-topology', 'traffic-control', 'udp-client-server', 'ipv6', 'udp', 'realtime', 'wireless', 'tutorial']
